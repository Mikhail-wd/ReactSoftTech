    ...
    <>
      ...
      <div className="banner__container">
        <div className="banner__box">
          <h1 className="banner__header">Умные IT-решения</h1>
          <h2 className="banner__sub-header">Выгодные и эффективные IT-решения для успешного бизнеса</h2>
        </div>
        <div className="banner__box-form">
