...
function PrivacyPolicyPage(props) {
  return (
    <div className="privacyPolicyPage__container">
      <title>Политика конфиденциальности СофтТек</title>
      <meta
        name="description"
        content="Узнайте о политике конфиденциальности СофтТек: как мы собираем и используем ваши данные. Защита ваших данных – наш приоритет!"
      />
      <meta
        name="keywords"
        content="политика конфиденциальности, СофтТек, обработка данных, защита данных, персональные данные"
      />
      <BreadCrumbs text={"Политика конфиденциальности"} />

      <div className="container">
        <h1 className="privacyPolicyPage__header">
          Политика в отношении обработки персональных данных
        </h1>

        <p className="privacyPolicyPage__text">
          ...
          безопасности персональных данных, предпринимаемые Индивидуальный
          предприниматель Кочнев Андрей Вадимович (далее – Оператор).
        </p>

        <p className="privacyPolicyPage__title">1. Общие положения</p>
        ...
        <p className="privacyPolicyPage__title">
        ...
        <p className="privacyPolicyPage__text">
          ...
          <br />
          – обрабатывать персональные данные в соответствие с целями ведения
          предпринимательской, коммерческой и деловой деятельности.
          <br />
          <br />
          3.2. Оператор обязан:
          <br />
        ...
        <p className="privacyPolicyPage__title">
          5. Данные и информация, обрабатываемые Оператором
        </p>
        ...
        <p className="privacyPolicyPage__text">
          ...
          интернет-статистики (Яндекс Метрика и Гугл Аналитика (Google
          Analytics) и других).
          <br />
          <br />
        ...
        <p className="privacyPolicyPage__text">
          ...
          электронной почты{" "}
          <a
            href="mailto:office@softtechgroup.ru"
            style={{ color: "#fedc5a", textDecoration: "underline" }}
          >
        ...
        <p className="privacyPolicyPage__text">
          ...
          <br />
          <br />
          9.8. Сбор персональных данных осуществляется с использованием сервисов
          "Яндекс Метрика", "1С-Битрикс" и "Битрикс24".
          <br />
          <br />
          9.9. Вся информация, которая собирается сторонними сервисами, в том
        ...
        <p className="privacyPolicyPage__text">
          ...
          *адрес электронной почты* с пометкой «Актуализация персональных
          данных».
          <br />
          <br />
          ...
          электронной почты на электронный адрес Оператора *адрес электронной
          почты* с пометкой «Отзыв согласия на обработку персональных данных».
          <br />
          <br />
        ...
        <p className="privacyPolicyPage__title">13. Заключительные положения</p>
